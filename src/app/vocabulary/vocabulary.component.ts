...
export class VocabularyComponent implements OnInit {
  ...
  quiztitle: string;
  currentSlide: number;
  constructor(config: NgbCarouselConfig, private vocabularyService: VocabularyService, private route: ActivatedRoute, private deviceService: DeviceDetectorService) {
