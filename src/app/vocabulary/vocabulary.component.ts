...
@Component({
  ...
  styleUrls: ['./vocabulary.component.sass'],
  providers: [VocabularyService, NgbCarouselConfig],
...
export class VocabularyComponent implements OnInit {
  ...
  quiztitle: string;
  currentSlide: number;
  constructor(private _location: Location, config: NgbCarouselConfig, private vocabularyService: VocabularyService, private route: ActivatedRoute, private deviceService: DeviceDetectorService) {
 ...
 loadData(filename) {
    this.subscription = this.vocabularyService.getData(filename).subscribe(
